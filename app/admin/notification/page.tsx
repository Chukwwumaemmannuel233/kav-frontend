...
export default function Notifications() {
 ...
 return (
  <div className="min-h-screen bg-[#f5f1ed] dark:bg-neutral-950 text-black dark:text-white">
    ...
    <main className="max-w-4xl mx-auto p-6">
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
        ...
        <button
          onClick={markAllRead}
          className="hidden md:block bg-black dark:bg-white text-white dark:text-black px-4 py-2 rounded transition"
        >
          Mark all read
        </button>
      </div>
      ...
      <div className="md:hidden mb-6">
        <button
          onClick={markAllRead}
          className="w-full bg-black dark:bg-white text-white dark:text-black py-3 rounded-lg transition"
        >
          Mark all as read
        </button>
      </div>
      ...
      <div className="space-y-4">
        {notifications.map((n) => (
          <div
            ...
            ${!n.is_read ? "border-l-4 border-orange-500" : "border border-neutral-200 dark:border-neutral-700"}
            `}
          >
            <div className="flex justify-between items-start">
              <div>
                ...
                <small className="text-gray-400 dark:text-neutral-500">
