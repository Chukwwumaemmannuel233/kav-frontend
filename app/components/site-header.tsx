...
function SiteHeaderUser() {
  ...
  return (
    <>
      <header className="border-b border-neutral-600 sticky top-0 z-40 bg-background">
      ...
      {/* Mobile Bottom Nav */}
      <nav className="md:hidden fixed bottom-0 left-0 right-0 border-t border-neutral-900 bg-background z-40">
