...
export default function PrivacyPolicy() {
  ...
  return (
    <main className="bg-background min-h-screen">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8">
              <h3 className="text-sm font-semibold mb-4 text-neutral-900 dark:text-neutral-100">
                Table of Contents
              </h3>
              ...
              <nav className="space-y-2">
                {tableOfContents.map((item) => (
                  <a
                    key={item.id}
                    href={`#${item.id}`}
                    className={`block text-sm transition-colors duration-200 px-3 py-2 rounded ${
          ...
          <div className="lg:col-span-3 space-y-12">
            ...
            <section id="introduction">
              ...
              <p className="text-neutral-400 leading-relaxed mb-4">
                Welcome to K.A.V Textile. We are committed to protecting your
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-neutral-400">
                    <li className="flex gap-3">
                      <span>•</span>
                      <span>
                        <strong>Contact Data:</strong> such as your first and
                        last name, email address, postal address, and phone
                        number.
                      </span>
                    </li>
                    <li className="flex gap-3">
                      <span>•</span>
                      <span>
                        <strong>Account Data:</strong> such as your username,
                    ...
                    <li className="flex gap-3">
                      <span>•</span>
                      <span>
                        <strong>Payment Data:</strong> We collect data necessary
                        to process your payment if you make purchases, such as
                        your payment instrument (such as a credit card number),
            ...
            <section id="how-we-share">
              ...
              <p className="text-neutral-400 leading-relaxed">
                ...
                data that we hold based on the following legal basis: vendors,
            ...
            <section id="data-security">
              ...
              <p className="text-neutral-400 leading-relaxed">
                ...
                personal information we process. We will only keep your personal
            ...
            <section id="your-rights">
              ...
              <p className="text-neutral-400 leading-relaxed">
                In some regions (like the European Economic Area and the UK),
            ...
            <section id="contact" className="pb-8">
              ...
              <p className="text-neutral-400 leading-relaxed mb-6">
                ...
                email us at privacy@K.A.V Textile.com or by post to:
              </p>
              <div className="bg-background p-6 rounded text-sm text-neutral-600 dark:text-neutral-400 space-y-1 border border-neutral-200 dark:border-neutral-800">
                <p>K.A.V Textile</p>
                <p>123 Brown strt</p>
      ...
      {/* Footer */}
      <footer className="bg-background border-t border-neutral-200 py-8 px-6">
